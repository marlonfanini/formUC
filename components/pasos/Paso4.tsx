...
function Paso4()  {
  ...
  return (
    <>
        ...
        <SwitchComponent label={"¿Es residente de Estados Unidos?"}/>
        <SwitchComponent label={"¿Tiene nacionalidad de Estados Unidos?"}/>
        <SwitchComponent label={"¿Es ciudadano de los Estados Unidos?"}/>
        <SwitchComponent label={"¿Tiene identidad para el pago de impuestos (TIN o SSN) o tarjeta de identidad de Estados Unidos (Green Card)?"}/>
